...
class GA:
    ...
    def funGA_main(self):
        ...
        listiDiversityMetric.append(self.funMeasurePopDiversity(listdictInitPop))
        ...
        for gen in range(self.iGenNum):
            ...
            listiDiversityMetric.append(self.funMeasurePopDiversity(listdictCurrPop))
