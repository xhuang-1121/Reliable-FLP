...
class GA:
    ...
    def funWeakLocalNeighborhood(self, fp_listdictCurrPop):
        ...
        # 弱local search
        tem_LSedIndNumEveGen = min(self.iPopSize, self.iLocalSearchIndNumEveGen)
...
if __name__ == '__main__':
    ...
    listFeXCoordinate = [
        listiFitEvaNumByThisGen[int(listfFeIndex[i])]
