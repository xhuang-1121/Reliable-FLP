...
def funGA_parallel_8ins():
    ...
    plotFile = open('/home/zhanghan/pythonworkspace/reliableFLPm=AllSelcFaci/10-node_GA_poltData(m=#SelectedNodes)-first8.txt', 'a')
    textFile = open('/home/zhanghan/pythonworkspace/reliableFLPm=AllSelcFaci/10-node_GA_EveInsData(m=#SelectedNodes)-first8.txt', 'a')
    f = open(insName, 'rb')
    list_ins = []
    ...
    plt.savefig("10-node_GA_ConvergenceCurve(m=#SelectedNodes)-first8")
    # 将数据写入text文件
    ...
    np.savetxt("/home/zhanghan/pythonworkspace/reliableFLPm=AllSelcFaci/10-node_GA_ObjValueEveInsEveRun(m=#SelectedNodes)-first8.txt", a_2d_fEveInsEveRunObjValue)
    excelName = '10-node_GA_ObjValueEveInsEveRun(m=#SelectedNodes)-first8.xls'
