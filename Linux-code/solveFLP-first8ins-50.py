...
def funGA_parallel_8ins():
    ...
    plt.title("Convergence Curves (50-node, m=#SelectedNodes)")
    plt.savefig("50-node_GA_ConvergenceCurve(m=#SelectedNodes)-first8")
    # 将数据写入text文件
    ...
    np.savetxt("/home/zhanghan/pythonworkspace/reliableFLPm=AllSelcFaci/50-node_GA_ObjValueEveInsEveRun(m=#SelectedNodes)-first8.txt", a_2d_fEveInsEveRunObjValue)
    excelName = '50-node_GA_ObjValueEveInsEveRun(m=#SelectedNodes)-first8.xls'
