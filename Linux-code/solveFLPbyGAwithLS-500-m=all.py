...
def funGALS_parallel():
    ...
    plt.savefig("500-node_GAwithLS_ConvergenceCurve(m=all)")
    # 将数据写入text文件
    ...
    np.savetxt("/home/zhanghan/pythonworkspace/reliableFLPm=AllSelcFaci/500-node_GAwithLS_ObjValueEveInsEveRun(m=all).txt", a_2d_fEveInsEveRunObjValue)
    excelName = '500-node_GAwithLS_ObjValueEveInsEveRun(m=all).xls'
