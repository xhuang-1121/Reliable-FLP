...
def funGA_parallel():
    ...
    textFile = open('/home/zhanghan/pythonworkspace/reliableFLP/100-node_GA_EveInsData(m=2).txt', 'a')
    f = open(insName, 'rb')
    list_ins = []
    ...
    np.savetxt("/home/zhanghan/pythonworkspace/reliableFLP//100-node_GA_ObjValueEveInsEveRun(m=2).txt", a_2d_fEveInsEveRunObjValue)
