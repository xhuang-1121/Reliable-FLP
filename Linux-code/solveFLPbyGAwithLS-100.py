...
def funGALS_parallel():
    ...
    textFile = open('/home/zhanghan/pythonworkspace/reliableFLPm=2/100-node_GAwithLS_EveInsData(m=2).txt', 'a')
    f = open(insName, 'rb')
    list_ins = []
    ...
    plt.savefig("100-node_GAwithLS_ConvergenceCurve(m=2)")
    # 将数据写入text文件
    ...
    np.savetxt("/home/zhanghan/pythonworkspace/reliableFLPm=2/100-node_GAwithLS_ObjValueEveInsEveRun(m=2).txt", a_2d_fEveInsEveRunObjValue)
    excelName = '100-node_GAwithLS_ObjValueEveInsEveRun(m=2).xls'
